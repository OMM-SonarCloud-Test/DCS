...
kmc_mmt_kmccrypto_mariadb_default_config_rev =  ['cryptolib.sadb.type=mariadb','cryptolib.crypto.type=kmccryptoservice','cryptolib.process_tc.ignore_antireplay=true',
                                                 ...
                                                 'cryptolib.sadb.mariadb.username=testuser2','cryptolib.sadb.mariadb.password=', #mtls, no password needed
                                                 'cryptolib.sadb.mariadb.tls.cacert=/home/isaleh/git/KMC/CryptoLib-IbraheemYSaleh/util/etc/ammos-ca-bundle.crt',
                                                 'cryptolib.sadb.mariadb.tls.verifyserver=true',
                                                 'cryptolib.sadb.mariadb.mtls.clientcert=/home/isaleh/git/KMC/CryptoLib-IbraheemYSaleh/util/etc/local-test-cert.pem',
                                                 'cryptolib.sadb.mariadb.mtls.clientkey=/home/isaleh/git/KMC/CryptoLib-IbraheemYSaleh/util/etc/local-test-key.pem',
                                                 'cryptolib.sadb.mariadb.require_secure_transport=true',
                                                 'cryptolib.crypto.kmccryptoservice.protocol=https','cryptolib.crypto.kmccryptoservice.fqdn=asec-cmdenc-srv1.jpl.nasa.gov',
                                                 'cryptolib.crypto.kmccryptoservice.app=crypto-service','cryptolib.crypto.kmccryptoservice.mtls.clientcert=/home/isaleh/git/KMC/CryptoLib-IbraheemYSaleh/util/etc/local-test-cert.pem',
                                                 'cryptolib.crypto.kmccryptoservice.mtls.clientcertformat=PEM','cryptolib.crypto.kmccryptoservice.mtls.clientkey=/home/isaleh/git/KMC/CryptoLib-IbraheemYSaleh/util/etc/local-test-key.pem',
                                                 'cryptolib.crypto.kmccryptoservice.cacert=/home/isaleh/git/KMC/CryptoLib-IbraheemYSaleh/util/etc/ammos-ca-bundle.crt','cryptolib.crypto.kmccryptoservice.verifyserver=true',
...
class TestConfigMethods(unittest.TestCase):
    ...
    #     k = KmcSdlsClient.KmcSdlsClient(kmc_mmt_kmccrypto_mariadb_default_config_rev)
    #     k.shutdown()
